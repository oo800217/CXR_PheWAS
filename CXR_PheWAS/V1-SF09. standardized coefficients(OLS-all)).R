...
data_path <- 'data/explainable_aucs (OLS-all).RData'

plot_path <- 'result/Fig S09.pdf'
...
coef_p <- coef_p + geom_text(aes(label = ifelse(value < 0.05 & value > -0.05, '', sprintf("%.2f", value))), size = 2, color = "black")
