...
table_path <-  'result/Table 02.csv'
...
if (!dir.exists(dirname(table_path))) {dir.create(dirname(table_path), recursive = TRUE)}

write.csv(selected_model_info, table_path, na = '', row.names = FALSE, quote = TRUE, fileEncoding = 'CP950')
